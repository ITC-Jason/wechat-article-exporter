...
export function getApis(t: Translate) {
  return [
    {
      name: t('api.docs.searchAccount'),
      description: t('api.docs.searchAccountDesc'),
      url: '/api/public/v1/account',
      method: 'GET',
      params: [
        {
          label: t('api.docs.keyword'),
          name: 'keyword',
          location: 'query',
          required: true,
          default: 'N/A',
        ...
        {
          label: t('api.docs.begin'),
          name: 'begin',
          location: 'query',
          required: false,
          default: '0',
          type: 'Int',
          remark: t('api.docs.beginRemark'),
        },
        {
          label: t('api.docs.size'),
          name: 'size',
          location: 'query',
          required: false,
          default: '5',
          type: 'Int',
          remark: t('api.docs.sizeRemark'),
        },
      ],
      responseSample: {
        base_resp: {
    ...
    {
      name: t('api.docs.searchByUrl'),
      description: t('api.docs.searchByUrlDesc'),
      url: '/api/public/v1/accountbyurl',
      method: 'GET',
      params: [
        {
          label: t('api.docs.articleUrl'),
          name: 'url',
          location: 'query',
          required: true,
          default: 'N/A',
    ...
    {
      name: t('api.docs.articleList'),
      description: t('api.docs.articleListDesc'),
      url: '/api/public/v1/article',
      method: 'GET',
      params: [
        {
          label: t('api.docs.fakeid'),
          name: 'fakeid',
          location: 'query',
          required: true,
          default: 'N/A',
        ...
        {
          label: t('api.docs.messageSize'),
          name: 'size',
          location: 'query',
          required: false,
          default: '5',
          type: 'Int',
          remark: t('api.docs.messageSizeRemark'),
        },
      ],
      responseSample: {
        base_resp: {
    ...
    {
      name: t('api.docs.download'),
      description: t('api.docs.downloadDesc'),
      ...
      params: [
        {
          ...
          default: 'N/A',
          type: 'String',
          remark: t('api.docs.urlEncoded'),
        },
        {
          label: t('api.docs.format'),
          name: 'format',
          location: 'query',
          required: false,
          default: 'html',
          type: 'String',
          remark: t('api.docs.formatRemark'),
        },
      ],
      responseSample: {},
      remark: t('api.docs.noAuthRequired'),
    },
    {
      name: t('api.docs.authorInfo'),
      description: t('api.docs.authorInfoDesc'),
    ...
    },
    {
      ...
      params: [
        ...
        {
          label: t('api.docs.key'),
          name: 'key',
          location: 'query',
          required: false,
          default: 'N/A',
          type: 'String',
          remark: t('api.docs.wechatKeyRemark'),
        },
      ],
      responseSample: {
        base_resp: {
...
export const apis = getApis(key => key);
